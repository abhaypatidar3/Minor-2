...
import { FiLoader, FiBookmark, FiMessageCircle } from 'react-icons/fi';
...
export default function MyProjects() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6">
      ...
      {projects.length === 0 ? (
        <p className="text-gray-500 text-center">You have no projects yet.</p>
      ) : (
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <span
                  className={`px-3 py-1 text-xs font-semibold rounded-full ${
                    proj.status === 'OPEN' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                  }`}
                >
                  {proj.status}
                </span>
