      ...
      >
        <div className="text-center text-white">
          ...
          <p className="mt-2 text-lg">
            Discover verified profiles, check reviews, and choose how you want
            to collaborate.
          </p>
        </div>
      </header>
            ...
            >
              ...
              <div className="mt-4 flex space-x-2">
                <Link
                  ...
                  className="flex-1 text-center bg-white border border-gray-300 text-gray-800 py-1 rounded-lg hover:bg-gray-200 transition"
                >
                  View Profile
                </Link>
                <Link
                  to={`/hire/${p.username}`}
                  className="flex-1 text-center bg-yellow-400 text-black py-1 rounded-lg hover:opacity-90 transition"
                >
                  Hire
                </Link>
              </div>
